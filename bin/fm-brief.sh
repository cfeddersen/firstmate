...
# description, acceptance criteria, and context, fills the {OUT_OF_SCOPE}
# placeholder with the work this task must refuse, and may adjust other sections
...
EOF
echo "scaffolded: $BRIEF (scout; replace {TASK}, {OUT_OF_SCOPE})"
exit 0
fi
...
$DOD
EOF
echo "scaffolded: $BRIEF (ship, mode=$MODE; replace {TASK}, {OUT_OF_SCOPE})"
