...
- ask-user findings: escalate to firstmate using rule 6's ask-user format and stop, with one narrow self-resolution exception.
  ...
  If any condition is unmet or you are unsure, escalate to firstmate using rule 6's ask-user format and stop - never self-approve on uncertainty.
