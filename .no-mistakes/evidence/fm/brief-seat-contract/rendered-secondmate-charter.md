...
Firstmate steers you through durable message files in '/var/folders/_3/klqsxx153k94qb8tvbb5f5g40000gn/T/tmp.6bFwrCaaCh/home3/state/demo-sm.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/var/folders/_3/klqsxx153k94qb8tvbb5f5g40000gn/T/tmp.6bFwrCaaCh/home3/state/demo-sm.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/var/folders/_3/klqsxx153k94qb8tvbb5f5g40000gn/T/tmp.6bFwrCaaCh/home3/state/demo-sm.inbox'/NNN.msg '/var/folders/_3/klqsxx153k94qb8tvbb5f5g40000gn/T/tmp.6bFwrCaaCh/home3/state/demo-sm.inbox'/handled/`.
The move IS the acknowledgement: without it firstmate rings again and eventually treats you as stuck. An empty or absent inbox needs no action.

# Escalation to main firstmate
Handle routine work yourself.
Report only true captain-relevant outcomes or a declared external wait by appending one line:
   `echo "{state}: {one short line}" >> '/var/folders/_3/klqsxx153k94qb8tvbb5f5g40000gn/T/tmp.6bFwrCaaCh/home3/state/demo-sm.status'`
...
If this charter cannot be carried out, append `blocked: {what is missing}; attempted: {what was already tried}; next: {smallest concrete action that would clear it}` or `failed: {why}` to the main status file and stop.
